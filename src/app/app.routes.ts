...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'products',
        loadChildren: () => import('../app/modules/products/routes').then((m) => m.routes)
      },
       {
        path: 'category',
        loadChildren: () => import('../app/modules/category/category-routing.module').then((m) => m.CategoryRoutingModule)
      },
      {
        path: 'theme',
